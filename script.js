// 在這裡加入 JavaScript 程式碼
        ...
        const columnData = [
            // 欄位 1 的選項和結果
            [
                { text: 'CBC/DC', result: '胸部X光：可能顯示肺水腫、氣胸或肺炎。' },
                { text: 'Glucose', result: '心電圖：評估心律不整或心肌缺血。' },
                { text: 'Na/K', result: '動脈血氣體分析：評估氧合及酸鹼平衡。' },
                { text: 'BUN/Crea', result: '血氧飽和度：初步判斷缺氧情況。' },
                { text: 'AST/ALT', result: '完整血球計數：檢查貧血或感染指標。' },
                { text: 'CRP', result: '生物標記物：如BNP、Troponin，評估心衰竭或心肌梗塞。' },
                { text: 'Hs-Troponin I', result: '電解質：評估代謝性問題或脫水。' },
                { text: 'Albumin', result: '血糖：排除糖尿病酮酸中毒等原因。' },
                { text: 'Lactate', result: '胸部超音波：快速評估肺積水或氣胸。' },
                { text: 'XX', result: 'D-dimer：懷疑肺栓塞時的輔助檢查。' }
            ],
            // 欄位 2 的選項和結果
            [
                { text: 'ABG', result: '肺功能測試：評估氣道阻塞或限制性疾病。' },
                { text: 'VBG', result: '胸部電腦斷層：更精確地評估肺部結構。' },
                { text: 'D-Dimer', result: '肺通氣/灌注掃描：評估肺栓塞。' },
                { text: 'PT/aPTT', result: '心臟超音波：評估心臟結構及功能。' },
                { text: 'XX', result: '腹部超音波：評估腹部病因。' },
                { text: 'XX', result: '肝腎功能：評估系統性疾病。' },
                { text: 'XX', result: '甲狀腺功能：排除甲狀腺機能亢進。' },
                { text: 'XX', result: '毒物篩檢：懷疑藥物中毒時。' },
                { text: 'XX', result: '支氣管鏡檢查：直接觀察氣道狀況。' },
                { text: 'XX', result: '動脈血壓監測：持續觀察血壓變化。' }
            ],
            // 欄位 3 的選項和結果（新增圖片路徑屬性）
            [
                { text: 'CXR', result: '氣管內管置入：當病人呼吸衰竭時。', image: 'images/image1.jpg' },
                { text: 'EKG', result: '胸管置入：用於排除氣胸或血胸。', image: 'https://via.placeholder.com/200x150/007bff/ffffff?text=Image+2' },
                { text: 'Echo', result: '非侵入性呼吸器：如BiPAP，協助呼吸。', image: 'https://via.placeholder.com/200x150/28a745/ffffff?text=Image+3' },
                { text: 'Chest CT', result: '藥物治療：根據病因給予支氣管擴張劑、利尿劑等。', image: 'https://via.placeholder.com/200x150/dc3545/ffffff?text=Image+4' },
        ...
        submitBtn.addEventListener('click', () => {
            ...
            resultColumn1.innerHTML = '<h3>血液/生化檢查(正常參考值)</h3>';
            resultColumn2.innerHTML = '<h3>其他檢查(正常參考值)</h3>';
